...
//
// const (
// 	pathMatcherFull pathMatcherType = iota
// 	pathMatcherPrefix
// 	pathMatcherRegex
// )
//
...
type int64RangeJSON struct {
	Start, End int64
}

type headerMatcherJSON struct {
	Name        string
	InvertMatch bool
	// At most one of the match can be set
	ExactMatch, RegexMatch, PrefixMatch, SuffixMatch *string
	RangeMatch                                       *int64RangeJSON
	PresentMatch                                     *bool
}
