...
// Replace removes the previous value and sends the new value on the underlying
// channel. It's expected to be used with channel with size 1, but there's no
// check to enforce that.
