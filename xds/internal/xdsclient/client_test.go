...
func overrideNewController() (*testutils.Channel, func()) {
	...
	newController = func(config *bootstrap.Config, pubsub *pubsub.Pubsub, validator xdsresource.UpdateValidatorFunc, logger *grpclog.PrefixLogger) (controllerInterface, error) {
