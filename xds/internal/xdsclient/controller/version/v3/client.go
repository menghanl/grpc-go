...
func init() {
	version2.RegisterAPIClientBuilder(version.TransportV3, newClient)
}
...
func newClient(opts version2.BuildOptions) (version2.VersionedClient, error) {
...
func (v3c *client) ParseResponse(r proto.Message) (xdsresource.ResourceType, []*anypb.Any, string, string, error) {
	...
	default:
		return rType, nil, "", "", version2.ErrResourceTypeUnsupported{
