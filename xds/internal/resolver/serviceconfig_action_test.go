	...
	tests := []struct {
	...
	}{
		{
			...
			newActions: map[string]action{
				...
				// FIXME: having one extra new action causes race picking 0 vs picking 2.
				// "a40_b40_c20_": {
				// 	clustersWithWeights: map[string]uint32{"a": 40, "b": 40, "c": 20},
				// 	clusterNames:        "a_b_c_",
				// },
				"c50_d50_": {
